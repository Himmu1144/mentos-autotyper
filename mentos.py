...
class Ui_Mentos(object):
    def setupUi(self, Mentos):
        Mentos.setObjectName("Mentos")
        Mentos.setFixedSize(800, 690)
        icon = QtGui.QIcon()
        logo_path = resource_path('logo_mian.ico')
        icon.addPixmap(QtGui.QPixmap(logo_path), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        Mentos.setWindowIcon(icon)
        self.centralwidget = QtWidgets.QWidget(Mentos)
...
"padding-right:19;")
        ...
        self.horizontalLayout_2.setContentsMargins(22, 4, 0, 0)
...
"")
        ...
        self.name1_icon.setCursor(QtGui.QCursor(QtCore.Qt.PointingHandCursor))
        ...
        insta_path = resource_path('instlogo.jpg')
        self.name1_icon.setPixmap(QtGui.QPixmap(insta_path))
        ...
        self.name2_icon.setCursor(QtGui.QCursor(QtCore.Qt.PointingHandCursor))
        ...
        self.name2_icon.setPixmap(QtGui.QPixmap(insta_path))
        ...
        Mentos.setCentralWidget(self.centralwidget)

        self.retranslateUi(Mentos)
        QtCore.QMetaObject.connectSlotsByName(Mentos)

    def retranslateUi(self, Mentos):
        _translate = QtCore.QCoreApplication.translate
        Mentos.setWindowTitle(_translate("Mentos", "Mentos"))
        self.code_input.setPlaceholderText(_translate("Mentos", "Paste the Python code here..."))
        self.python.setText(_translate("Mentos", "python"))
        self.python.setChecked(True)
        self.non_python.setText(_translate("Mentos", "non-python"))
        self.normal_text.setText(_translate("Mentos", "normal text"))
        self.mentos_button.setText(_translate("Mentos", "Mentos!"))
        self.mentos_button.setShortcut(_translate("Mentos", "Ctrl+M"))
        self.running_label.setText(_translate("Mentos", "running..."))
        self.clear_text_button.setText(_translate("Mentos", "Clear Text"))
        self.clear_text_button.setShortcut(_translate("Mentos", "Shift+Esc"))
        self.created_by_label.setText(_translate("Mentos", "Created by -"))
        self.name1.setText(_translate("Mentos", "Shreyans Singh"))
        self.username1.setText(_translate("Mentos", "thesilentarrow"))
        self.name2.setText(_translate("Mentos", "Himanshu Sharma"))
        self.username2.setText(_translate("Mentos", "himmu1144"))
        self.note_label.setText(_translate("Mentos", "Paste the code in the above box, click on Mentos!, place the cursor where you want to autotype the code then press \"escape key\" and enjoy!"))


#autotyper code
class Main(QMainWindow, Ui_Mentos):
    ...
    def start_autotyping(self): 
        ...
        if self.hot==0:
            if self.python.isChecked():
                ...
                keyboard.add_hotkey('f4', start_autotyper_python)
                self.hot=1
            if self.non_python.isChecked():
                print("for python")
                keyboard.add_hotkey('escape', start_autotyper_java)
                keyboard.add_hotkey('f4', start_autotyper_java)
                self.hot=1
            if self.normal_text.isChecked():
                print("simple text")
                keyboard.add_hotkey('escape', start_autotyper_text)
                keyboard.add_hotkey('f4', start_autotyper_text)
                self.hot=1
